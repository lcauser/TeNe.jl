    ...
    @testset "_create_trotter_gate_compressed" begin
        ...
        @testset "three sites" begin
            ...
            @test begin
                ...
                op2 =
                    -1.4*tensorproduct(
                        tensorproduct([1 0; 0 -1], [0 1; 1 0]; tocache = false),
                        [1 0; 0 -1];
                        tocache = false,
                    )
                op2 +=
                    0.56/2*tensorproduct(
                        tensorproduct([1 0; 0 -1], [1 0; 0 -1]; tocache = false),
                        [1 0; 0 1];
                        tocache = false,
                    )
                op2 +=
                ...
                op2 +=
                    0.34/3*tensorproduct(
                        tensorproduct([0 1; 1 0], [1 0; 0 1]; tocache = false),
                        [1 0; 0 1];
                        tocache = false,
                    )
                op2 +=
